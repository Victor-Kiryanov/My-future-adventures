...
# ЧАСТИНА НА JAVA
# Сторінка для роботи з Базою Даних та обробка черги
...
# Після підключення - оператору доступно поточна заявка для розгляду (оператор може від'єднатися натиснувши посилання або натиснути "Підтвердити заявку": зміниться статус заявки, а також автоматично призначиться наступна заявка зі статусом "НОВА")
![Снимок](https://user-images.githubusercontent.com/90868360/168688978-96ff606f-14b1-4cdc-84b4-ccfcd7d660b6.JPG)
# Після розгляду заявки перевіремо її статус, для цього введемо статус "Виповнено-оброблено" у пункт 7
...
# Перейдемо знову до другого оператора та оброблемо заявку (яка автоматично привласнилась оператору)
